      ...
      <Show when={!loading}>
        ...
        <div className="p-4 bg-gray-100 rounded">
          <p className="leading-8">
            <InfoIcon color="black" /> This sample demonstrates how to
            initialize and keep the barcode scanner running in the background,
            despite re-renderings happening in a React application.
          </p>
        </div>
